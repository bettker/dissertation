...
\begin{abstract}
    ...
    Our resulting neural network heuristic has higher coverage than a basic satisficing heuristic. Compared to a baseline learned heuristic, our best neural network heuristic almost doubles the mean coverage and can increase it for some domains by more than six times.
\end{abstract}
...
\translatedkeyword{Qualidade das Amostras}
