...
\begin{definition}[Variable]\label{def:variable}
    A variable $v$ is a concise representation of a condition or characteristic of the environment. It has the ability to assume any value from a predefined domain~$D(v)$.
\end{definition}
