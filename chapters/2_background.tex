...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[every node/.style={circle, draw}, node distance=23mm, minimum size=9mm]
        ...
        \draw[-Straight Barb] (s0) -- (s2);
        \draw[-Straight Barb] (s0) -- (s1);
        \draw[-Straight Barb] (s0) -- (s3);
        \draw[-Straight Barb] (s2) -- (s5);
        \draw[-Straight Barb] (s2) -- (s6);
        \draw[-Straight Barb] (s3) -- (s6);
        \draw[-Straight Barb] (s4) -- (s2);
        \draw[-Straight Barb] (s5) -- (s7);
        \draw[-Straight Barb] (s9) -- (goal);
        \draw[-Straight Barb] (s7) -- (s8);
        \draw[-Straight Barb] (s7) -- (s9);
        \draw[-Straight Barb] (s7) -- (s10);
        \draw[-Straight Barb] (s8) -- (s6);
        \draw[-Straight Barb] (s1) -- (s4);
        \draw[-Straight Barb] (s10) -- (s11);
      \end{tikzpicture}
\end{figure}
